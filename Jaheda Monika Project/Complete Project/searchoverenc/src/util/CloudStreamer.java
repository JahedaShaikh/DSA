    ...
    while (true)
    {
        ...
        if(!SensorDatakeeper.q.isEmpty())
        {
          ...
          //   System.out.print("SensorDatakeeper.q "+str);
                    ...
                    String sensorval3=sp[2];
                    String sensorval4=sp[3];
                    String date=sp[4];
                    String time=sp[5];
                ...
                //   System.out.println(sensorval1+"  "+sensorval2);
                   ...
                   String encsenval3=new ReverseEncryptionHelper().startEncryption(sensorval3, key);
                   String encsenval4=new ReverseEncryptionHelper().startEncryption(sensorval4, key);
                  ...
                  // System.out.println("   Sensor val 1 "+encsenval1+" Sensor val 2 "+" date "+encdate+" time "+time);
                   ...
                   if(sf.insertSensorinfo(st, encsenval1, encsenval2,encsenval3,encsenval4, encdate, enctime))
                   {
